...
function App() {
  //Handling the toggle for dark mode
  ...
  return (
    <>
      <button
        ...
        className="fixed p-2 z-10 right-5 top-5 text-lg rounded-md bg-indigo-400 dark:bg-amber-300"
      >
